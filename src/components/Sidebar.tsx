...
const subNav = [
  ...
  { href: "/history", label: "Pay History", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
  { href: "/cashflow", label: "Cash Flow", icon: "M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" },
  { href: "/change-orders", label: "Change Orders", icon: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" },
  ...
  { href: "/retainage", label: "Retainage", icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" },
];
...
export default function Sidebar({ role, companyName }: SidebarProps) {
  ...
  const nav = role === "GC" || role === "ADMIN" ? gcNav : subNav;
    ...
    <aside className="w-64 bg-gray-900 text-white flex flex-col min-h-screen fixed left-0 top-0 z-30">
      ...
      <div className="p-6 border-b border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold text-white text-lg leading-none">PipePay</p>
            <p className="text-gray-400 text-xs mt-0.5">
              {role === "GC" || role === "ADMIN" ? "GC Portal" : "Sub Portal"}
            </p>
          </div>
        </div>
        {companyName && (
          <p className="text-gray-300 text-xs mt-3 truncate">{companyName}</p>
        )}
      </div>
      ...
      <div className="p-4 border-t border-gray-700">
        <p className="text-gray-500 text-xs text-center">PipePay v1.0</p>
      </div>
    </aside>
  );
}
